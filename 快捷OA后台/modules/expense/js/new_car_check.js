...
var isFaultSalesman = false;
var isAccidentObservation = false;
...
isFaultSalesman = userRoleList.indexOf(config.faultSalesman) > -1;
isAccidentObservation = userRoleList.indexOf(config.accidentObservation) > -1;
console.log(isFaultDriver);
console.log(isFaultManage);
console.log(isFaultDispatch);
console.log(isFaultSalesman);
...
(function () {
    vueObj = new Vue({
        ...
        data: {
            ...
            isFaultSalesman: isFaultSalesman,
            isAccidentObservation:isAccidentObservation,
            state: 1,
                ...
                formatter: function (value, options, row) {
                    switch (value) {
                        case '1':
                            ...
                            break;
                        case '6,7,8':
                            return '<span class="label label-danger">已处理</span>';
                            break;
                        // case 3:
...
*/
        ...
        inquiry("该操作不能撤回是否继续", function () {
            ...
            if (data[0].start == '2') {
                Tool.ajaxHelper.ajaxSubmit({
                    ...
                    Api.new_car_check.update, "POST", function () {
                        tips("调度成功");
                        list.bootstrapTableTemplateQuery({});
                    }
                );
    ...
    $(".dws").click(function () {
        ...
        $.get(Api.new_car_check.info + "/" + id, {}, function (_data) {
            switch (_data.code) {
                case 0:
                    console.log(_data);
                                ...
                                success: function (_layero, _index) {
                                    ...
                                    $("#saveBtn").click(function (e) {
                                        Tool.ajaxHelper.ajaxSubmit({
                                            ...
                                            Api.new_car_check_report.update, "POST", function (_data2) {
                                                tips("操作成功");
                                                list.bootstrapTableTemplateQuery({});
                                            }
                                        );
                                ...
                                success: function (_layero, _index) {
                                    ...
                                    $("#submitBtn").click(function (e) {
                                        ...
                                        layer.confirm('表格提交后将不可修改，是否确认提交？', {
                                            ...
                                            $("#saveBtn").click();
                                            $.post(Api.new_car_check.updateState, {
                                                id: id,
                                                startH: 2,
                                            }, function (_data) {
                                                switch (_data.code) {
    ...
    $(".reviewAdopt").click(function () {
        ...
        inquiry("该操作不能撤回是否继续", function () {
            ...
            Tool.ajaxHelper.ajaxSubmit({
                ...
                Api.new_car_check.updateState, "GET", function () {
                    tips("操作成功");
                    list.bootstrapTableTemplateQuery({});
                }
            );
    ...
    $(".complete").click(function () {
        ...
        inquiry("该操作不能撤回是否继续", function () {
            ...
            tool.ajaxHelper.ajaxSubmit({
                ...
                start: 5,
                userId: userId
            }, Api.new_car_check.update, "POST", function (_data) {
                switch (_data.code) {
                    case 0:
                        tips("操作成功");
                        list.bootstrapTableTemplateQuery({});
