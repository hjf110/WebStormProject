...
(function ($) {
    ...
    $.fn.fileinputLocales['gl'] = {
        ...
        msgUploadAborted: 'controller carga de arquivos cancelouse',
        ...
        msgImageHeightSmall: 'controller altura de la imaxe "{name}" debe ser de al menos {size} px.',
        ...
        msgAjaxProgressError: 'controller operación {operation} fallou',
        ajaxOperations: {
