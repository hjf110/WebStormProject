...
(function ($) {
    ...
    $.fn.fileinputLocales['pt'] = {
        ...
        msgLoading: 'controller carregar ficheiro {index} de {files} &hellip;',
        msgProgress: 'controller carregar ficheiro {index} de {files} - {name} - {percent}% completo.',
        ...
        fileActionSettings: {
            ...
            indicatorLoadingTitle: 'controller carregar ...'
        },
