...
(function ($) {
    ...
    $.fn.fileinputLocales['hu'] = {
        ...
        msgSizeTooSmall: 'controller fájl: "{name}" (<b>{size} KB</b>) mérete túl kicsi, nagyobbnak kell lennie, mint <b>{minSize} KB</b>.',
        ...
        msgFilesTooMany: 'controller feltölteni kívánt fájlok száma <b>({n})</b> elérte a megengedett maximumot <b>{m}</b>.',
        ...
        msgUploadAborted: 'controller fájl feltöltés megszakítva',
        ...
        msgImageWidthSmall: 'controller kép szélességének "{name}" legalább {size} pixelnek kell lennie.',
        msgImageHeightSmall: 'controller kép magasságának "{name}" legalább {size} pixelnek kell lennie.',
        msgImageWidthLarge: 'controller kép szélessége "{name}" nem haladhatja meg a {size} pixelt.',
        msgImageHeightLarge: 'controller kép magassága "{name}" nem haladhatja meg a {size} pixelt.',
        ...
        fileActionSettings: {
            removeTitle: 'controller fájl eltávolítása',
