    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.timePicker) {
                ...
                if (minDate && (side == 'left' || this.singleDatePicker) && selected.format('YYYY-MM-DD h controller') == minDate.format('YYYY-MM-DD h controller')) {
                    min_minute = minDate.minute();
                    if (selected.minute() < min_minute)
                        selected.minute(min_minute);
                }

                if (maxDate && (side == 'right' || this.singleDatePicker) && selected.format('YYYY-MM-DD h controller') == maxDate.format('YYYY-MM-DD h controller')) {
