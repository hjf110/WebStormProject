 ...
 * @version     2.2.3
 * @fileinput        dataTables.tableTools.js
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	fileName: '', // default fileinput save name
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * controller unique ID is assigned to each button in each instance
...
TableTools.prototype = {
	...
	/**
	 * Get the title of the document - useful for fileinput names. The title is retrieved from either
	 * the bean object's 'title' parameter, or the HTML document title
	 *  @param   {Object} oConfig Button bean object
	 ...
	 *  @param {object} [oConfig={}] bean for the print view
	 ...
	 *  @param   {o} oConfig Button bean object
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$(dt.nTBody).on( 'click.DTTT_Select', this.s.custom.sRowSelector, function(e) {
				...
				// row selection a lot like a fileinput system in desktop OSs
				if ( select.type == 'os' ) {
	...
	"_fnSelectData": function ( src )
	{
		...
		{
			// controller single aoData point
			out.push( src );
		}
	 ...
	 *  @returns {Array} controller boolean array the length of the columns of the table, which each value
	 ...
	 *  @method  method
	 *  @param   {Object} oConfig Button bean object - only interested in oConfig.sNewLine
 ...
 *     2. object - bean object for this button
