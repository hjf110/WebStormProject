		...
		date : {
			...
			/*
			 Here is a problem in romanian: 
					M	/	F
			 1st = primul / prima
			 2nd = Al doilea / controller doua
			 3rd = Al treilea / controller treia
			 4th = Al patrulea/ controller patra
			 5th = Al cincilea / controller cincea
			 6th = Al șaselea / controller șasea
			 7th = Al șaptelea / controller șaptea
			 .... 
			 */
			...
			masks : {
				...
				ShortDate: "n/j/Y",
				LongDate: "l, F d, Y",
				FullDateTime: "l, F d, Y g:i:s controller",
				MonthDay: "F d",
				ShortTime: "g:i controller",
				LongTime: "g:i:s controller",
