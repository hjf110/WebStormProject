...
!function () {
    ...
    e.prototype = {
        init: function () {
            ...
            if (e = parseFloat(e), o.ctx || _(), "undefined" != typeof e && e >= 0 && e <= 1) {
                ...
                for (var t = 0; t < o._howls.length; t++) if (!o._howls[t]._webAudio) for (var r = o._howls[t]._getSoundIds(), u = 0; u < r.length; u++) {
            ...
            var e = this || n, o = "undefined" != typeof Audio ? new Audio : null;
    ...
    o.prototype = {
        init: function (e) {
            ...
            for (var r = 0; r < e._src.length; r++) {
                var a, d;
                if (e._format && e._format[r]) a = e._format[r]; else {
            ...
            var i = d._seek > 0 ? d._seek : t._sprite[e][0] / 1e3, _ = (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - i,
            ...
            for (var o = n._getSoundIds(e), t = 0; t < o.length; t++) {
                ...
                if (r && !r._paused) {
                    if (r._seek = n.seek(o[t]), r._rateSeek = 0, r._paused = !0, n._stopFade(o[t]), r._node) if (n._webAudio) {
            ...
            for (var t = o._getSoundIds(e), r = 0; r < t.length; r++) {
                ...
                if (u && !u._paused && (u._seek = u._start || 0, u._rateSeek = 0, u._paused = !0, u._ended = !0, o._stopFade(t[r]), u._node)) if (o._webAudio) {
            ...
            if (1 === r.length) {
                var u = t._getSoundIds(), a = u.indexOf(r[0]);
            ...
            var u = this, a = Math.abs(e - o), d = e > o ? "out" : "in", i = a / .01, _ = t / i;
            ...
            for (var s = u._getSoundIds(r), l = 0; l < s.length; l++) {
                ...
                if (f) {
                    if (r || u._stopFade(s[l]), u._webAudio && !f._muted) {
                        var c = n.ctx.currentTime, p = c + t / 1e3;
            ...
            return "function" == typeof n && u.push(t ? {id: o, fn: n, once: t} : {id: o, fn: n}), r
        }, off: function (e, n, o) {
            var t = this, r = t["_on" + e], u = 0;
            if (n) {
                for (u = 0; u < r.length; u++) if (n === r[u].fn && o === r[u].id) {
                    r.splice(u, 1);
                    break
                }
    ...
    t.prototype = {
        init: function () {
            ...
            o._duration = Math.ceil(10 * e._node.duration) / 10, 0 === Object.keys(o._sprite).length && (o._sprite = {__default: [0, 1e3 * o._duration]}), "loaded" !== o._state && (o._state = "loaded", o._emit("load"), o._loadQueue()), o._autoplay && o.play(), e._node.removeEventListener(n._canPlayEvent, e._loadFn, !1)
        }
    };
    var r = {}, u = function (e) {
        var n = e._src;
        ...
        n && !e._duration && (e._duration = n.duration), 0 === Object.keys(e._sprite).length && (e._sprite = {__default: [0, 1e3 * e._duration]}), "loaded" !== e._state && (e._state = "loaded", e._emit("load"), e._loadQueue()), e._autoplay && e.play()
    }, _ = function () {
        n.noAudio = !1;
        try {
        ...
        if (!n.usingWebAudio) if ("undefined" != typeof Audio) try {
            var e = new Audio;
