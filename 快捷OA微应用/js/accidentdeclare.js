...
/*            alert(_data.name);*/
        ...
        for(var k in userJob){
            if(userJob[k].role == "accidentDispatch"||userJob[k].role == "accidentDriver"||userJob[k].role=="accidentManage"||userJob[k].role=="accidentSalesman"||userJob[k].role=="accidentObservation"||userJob[k].role=="accidentFinance"){
                isOk = true;
            }
        }
        if(!isOk){
