                    ...
                    $(".submitCgClBtn").click(function (_event) {
                        ...
                        if (($("#cg_je").val() == "2" && $("#cgclyj").val().length > 0) || $("#cg_je").val() == "1") {
                            ...
                            var dataStr = JSON.stringify({
                                ...
                                remark: $("#cgclyj").val(),
                                vehicleCompleteId: userJob.filter(function (_item, _index, _array) {
                                    return _item.role == "accidentManage"
                                })[0].userId,
                                vehicleCompleteName: userInfo.name
                            });
                            $.ajax(postOldCarUrl, {
                                data: dataStr,
                                type: "POST",
                            ...
                            $.ajax(postOldCarUrl, {
                                data: JSON.stringify({
                                    ...
                                    dispatchId: userJob.filter(function (_item, _index, _array) {
                                        return _item.role == "accidentDispatch"
                                    })[0].userId
                                }),
                                type: "POST",
                                contentType: "application/json",
                        ...
                        if ($("#Salesman2_je").val() != null && $("#Suggest2").val().length > 0) {
                            ...
                            var dataStr = JSON.stringify({
                                ...
                                salesmanId: userJob.filter(function (_item, _index, _array) {
                                    return _item.role == "accidentSalesman"
                                })[0].userId,
                            ...
                            if ($("#ddqr").val() == "kong" || $("#ddqr").val() == null) {
                                ...
                                $.ajax(postProblemUrl, {
                                    data: JSON.stringify({
                                        ...
                                        isDispatch: 2,
                                        dispatchName: userInfo.name,
                                        dispatchName: userJob.filter(function (_item, _index, _array) {
                                            return _item.role == "accidentDispatch"
                                        })[0].userId
                                    }),
                                    type: "POST",
                                ...
                                $(".ywy2Hide .submit2YwyBtn").click(function (_event) {
                                    ...
                                    if (($("#Salesman2_je").val() == "2" && $("#Suggest2").val().length > 0) || $("#Salesman2_je").val() == "1") {
                                        ...
                                        var dataStr = JSON.stringify({
                                            ...
                                            remark: $("#Suggest2").val(),
                                            salesmanId: userJob.filter(function (_item, _index, _array) {
                                                return _item.role == "accidentSalesmanNewCarCheck"
                                            })[0].userId,
                                            salesmanName: userInfo.name
                                        });
                    ...
                    if (reimbursementInfo.dispatchName) {
                        ...
                        $(".ddHide .submit2ddQrBtn").click(function (_event) {
                            ...
                            var dataStr = JSON.stringify({
                                ...
                                isDispatch: 2,
                                dispatchId: userJob.filter(function (_item, _index, _array) {
                                    return _item.role == "accidentDispatchNewCarCheck"
                                })[0].userId
                            });
                            $.ajax(postNewCarHandingUrl, {
                                data: dataStr,
