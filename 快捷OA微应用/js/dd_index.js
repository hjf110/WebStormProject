...
function initPageMain(){
    ...
    function getAjaxForSJList(){
        ...
        $.get(getSGListUrl,{company:jobInfo[0].companyKey,state:6,limit:10000,page:1,order:"ecs"},function(_data){
            for(var i in _data.page.records){
                ...
                $listItemClone.find(".listName").text(thisItem.driverName+"事故申请单");
