                    ...
                    case 1:
                        ...
                        $(".submit2YwyBtn").click(function(_event){
                            ...
                            if($("#Salesman2_je").val()!=null&&$("#Suggest2").val().length>0){
                                ...
                                var dataStr = JSON.stringify({id:id,start:state,vehicleHandleTime:parseInt(new Date().getTime()/1000),remark:$("#Suggest2").val(),salesmanId:userJob.filter(function(_item,_index,_array){return _item.role=="accidentSalesmanProblem"})[0].userId,salesmanName:userInfo.name});
                                $.ajax(postProblemUrl,{
                                    data:dataStr,
                                    type:"POST",
                                    contentType:"application/json",
                        ...
                        if(isDD&&reimbursementInfo.dispatchName==null){
                            ...
                            $(".ddHide .submit2ddQrBtn").click(function(_event){
                                ...
                                dd.device.notification.showPreloader({
                                    ...
                                    $.ajax(postProblemUrl,{
                                        data:JSON.stringify({id:id,isDispatch:2,dispatchName:userInfo.name,dispatchTime:parseInt(new Date().getTime()/1000),dispatchId:userJob.filter(function(_item,_index,_array){return _item.role == "accidentDispatchProblem"})[0].userId}),
                                        type:"POST",
                                        contentType:"application/json",
                                        processData:false,
                                        success:function(_data) {
